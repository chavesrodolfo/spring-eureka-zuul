...
public class GenericClientB {
	...
	public void sendRequestToServiceUsingEureka(EurekaClient eurekaClient) throws InterruptedException {
		...
		String vipAddress = "SPRING-REST-SERVICE-B";
		...
		for (int i = 0; i < 20; i++) {
			String response = template.getForObject(
					("http://192.168.99.100:8080/spring-rest-service-b/sysInfo"),
					String.class, new Object());

			System.out.println("Response from service B for sys info :" + response);

			String responseStack = template.getForObject(
					("http://192.168.99.100:8080/spring-rest-service-b/stackInfo"),
					String.class, new Object());

			System.out.println("Response from service B for stack info :" + responseStack);
			Thread.sleep(1000);
		}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("eureka.serviceUrl.default", "http://192.168.99.100:8761/eureka/");
